...
func TestParamsFromConf(t *testing.T) {
	...
	assert.Equal(t, map[string]interface{}{"DbAddress": "postgres://postgres:example@localhost:5432/postgres", "MessageTypesAllowed": []interface{}{int64(2)}}, conf.GetParams("postgresql"))
}
